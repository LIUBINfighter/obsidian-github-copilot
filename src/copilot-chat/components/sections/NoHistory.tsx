			...
			<div className="copilot-chat-no-history-warnings">
				<div className="copilot-chat-model-warning">
					...
					<p className="copilot-chat-model-warning-text">
						...
						them in your IDE first. Make a request in your IDE and
						click "Enable" when prompted.
					</p>
				</div>
				<div className="copilot-chat-model-warning">
					<h6 className="copilot-chat-model-warning-title">
						Some users have seen their Copilot access suspended
						after using this Chat extension.
					</h6>
					<p className="copilot-chat-model-warning-text">
						If you experience this, you can try to restore your
						access by contacting GitHub support. Use this chat
						extension at your own risk. Please see{" "}
